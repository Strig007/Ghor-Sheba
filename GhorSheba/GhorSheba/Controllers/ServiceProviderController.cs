...
namespace GhorSheba.Controllers
{
    ...
    public class ServiceProviderController : ApiController
    {
        ...
        [Route("api/ServiceProvider/GetSalary/{id:int}")]
        [HttpGet]
        public UserSalariesModel GetSalary(int id)
        {
            return ServiceProviderService.GetSalary(id);
        }

        [Route("api/ServiceProvider/EditBooking/{id:int}")]
        [HttpGet]
        public BookingModel EditBooking(int id)
        {
            return ServiceProviderService.EditBooking(id);
        }

        [Route("api/ServiceProvider/EditBooking")]
        [HttpPost]
        public void EditBooking(BookingModel b)
        {
            ServiceProviderService.EditBooking(b);
        }
    }
}
